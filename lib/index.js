...
var isTsType = args.includes('-t') || args.includes('--ts');
...
switch (command) {
  ...
  default:
    if (!command) (0, _helper["default"])();else {
      ...
      var output = outputIndex && args[outputIndex + 1] ? (0, _path.resolve)(process.cwd(), args[outputIndex + 1]) : (0, _path.resolve)(process.cwd(), 'react__from__vue');
      (0, _transform["default"])(input, output, isTsType);
    }
    break;
}